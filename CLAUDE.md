...
German licensed transport company (§ 49 PBefG *Mietwagen mit Fahrer*, Stuttgart/Esslingen region).
...
German-language public field labels — match `StepNow_Buchhaltung.html`. VAT: 7% passenger (PBefG), 19% courier — set per order.
