...
UI_STRINGS: list[tuple[str, str, str, str, str | None, bool]] = [
    ...
    ("about.values.reliability.body", "about", "Pünktlichkeit ist keine Höflichkeit, sondern die Grundlage unserer Arbeit.", "Punctuality is not a courtesy — it is the foundation of our work.", "Value body", False),
    ("about.values.safety.title", "about", "Sicherheit", "Safety", "Value title", False),
    ("about.values.safety.body", "about", "Geprüfte Fahrer, gewartete Fahrzeuge, volle Personenbeförderungs-Haftpflicht.", "Verified drivers, maintained vehicles, full passenger transport liability cover.", "Value body", False),
    ("about.values.transparency.title", "about", "Transparenz", "Transparency", "Value title", False),
    ("about.values.transparency.body", "about", "Der Preis steht vor der Fahrt fest. Keine versteckten Kosten, keine Überraschungen.", "The price is set before the ride. No hidden costs, no surprises.", "Value body", False),
    ("about.values.personal.title", "about", "Persönlicher Service", "Personal Service", "Value title", False),
    ("about.values.personal.body", "about", "Sie sprechen mit dem Inhaber — nicht mit einem anonymen Callcenter.", "You talk to the owner — not an anonymous call centre.", "Value body", False),
    ("about.credentials.heading", "about", "Qualifikationen & Zulassungen", "Credentials & Licenses", "Credentials heading", False),
    ("about.service_area.heading", "about", "Unser Einzugsgebiet", "Our service area", "Service area heading", False),
