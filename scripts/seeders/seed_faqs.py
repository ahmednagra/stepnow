...
FAQS = [
    ...
    # === PRICING ===
    {
        "sort_order": 10, "category": "pricing",
    ...
    {
        "sort_order": 10, "category": "flughafentransfer",
    ...
    {
        "sort_order": 20, "category": "flughafentransfer",
...
def run() -> None:
    ...
    try:
        ...
        for faq_data in FAQS:
            existing = db.query(Faq).filter(Faq.question_de == faq_data["question_de"]).first()
            if existing:
                skipped += 1
                continue
