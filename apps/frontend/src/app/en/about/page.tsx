...
// About page (EN mirror). Revalidate 1h; admin-bff invalidates settings/vehicles tags on mutation.
...
return buildMetadata({ title: t("about.page.title"), description: t("about.page.subhead"), path: "/en/about", locale: "en" });
}

export default async function AboutPageEn() {
const [stringsRes, settings, vehicles] = await Promise.all([getUiStringsServer("en"), getSettingsServer("en"), listVehiclesServer("en")]);
const t = createT(stringsRes.strings, "en");
...
<div className="md:col-span-5"><ValuesSection t={t} locale="en" /></div>
</Container>
</section>
<section className="border-t border-line bg-paper">
<Container className="grid items-start gap-10 py-10 md:grid-cols-12 md:gap-14 md:py-12">
<div className="md:col-span-7"><Credentials t={t} settings={settings} locale="en" /></div>
