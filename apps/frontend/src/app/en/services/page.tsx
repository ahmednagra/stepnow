...
<div>
<p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-gold-deep">{pickT(t, "services.page.eyebrow", "Services")}</p>
...
<br />
<span className="italic text-gold-deep">{pickT(t, "services.page.heading_part2", "to get there.")}</span>
</h1>
