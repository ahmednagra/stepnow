// apps/frontend/src/app/admin/(authed)/legal-pages/_client.tsx
// Client island: lists legal pages (browser bearer auth).
...
import { useLegalPages } from "@/hooks/queries";

export function LegalPagesListClient() {
