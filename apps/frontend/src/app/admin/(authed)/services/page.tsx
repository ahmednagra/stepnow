...
// Services list. Adds preview, debounced search, CSV/JSON export, refined design.
            ...
            <FilterToolbar
              ...
              filters={
                <select
                  ...
                  className="h-8 border border-slate-300 bg-white px-2 text-[12px] text-slate-700 focus:border-slate-900 focus:outline-none"
                  aria-label="Filter"
                >
                  ...
                  <AdminTableCell className="text-right">
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      <Link
                        ...
                        title="Edit"
                        className="grid h-7 w-7 place-items-center border border-slate-200 bg-white text-slate-500 transition-colors hover:border-slate-400 hover:text-slate-900"
                      >
