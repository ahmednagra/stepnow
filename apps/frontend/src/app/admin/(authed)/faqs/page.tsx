...
// FAQs list with debounced search, exports and preview.
            ...
            {loading ? (
              ...
              items.map((x) => (
                <AdminTableRow key={x.id} className={x.is_deleted ? "opacity-60" : ""}>
                  <AdminTableCell>
                    <Link href={`/admin/faqs/${x.id}`} className="font-medium text-slate-900 hover:underline line-clamp-1">
                      {x.question_de}
                    </Link>
