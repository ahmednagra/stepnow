...
// German homepage skeleton.
// Validates the full stack: layout (strings + settings) + services list +
// translation helper + components. Real visual treatment comes in Phase 3.
