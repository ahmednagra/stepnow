...
// Service-mix donut + legend. Wrapped in memo() — pairs with the already-memoised ServiceMixDonut to keep this card stable across unrelated parent updates.
...
function ServiceMixCardBase({ slices, total }: Props) {
return (
...
export const ServiceMixCard = memo(ServiceMixCardBase);
