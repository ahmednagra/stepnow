...
UI_STRINGS: list[tuple[str, str, str, str, str | None, bool]] = [
    ...
    (
        "home.hero.headline",
        "hero",
        "Sicher, pünktlich, zum Festpreis.",
        "Safe, on time, fixed price.",
    ...
    (
        "home.hero.subhead",
        "hero",
        "Vorbestellte Fahrten in der Region Stuttgart. Konzessioniert nach § 49 PBefG.",
        "Pre-booked transfers in the Stuttgart region. Licensed under § 49 PBefG.",
    ...
    (
        "hero_widget.note",
        "hero",
        "Unverbindliche Anfrage — Festpreis-Angebot innerhalb von 30 Minuten.",
        "Non-binding request — fixed-price quote within 30 minutes.",
    ...
    (
        ...
        "home",
        "Vier spezialisierte Transportdienstleistungen — alle vorbestellt, alle zum Festpreis.",
        "Four specialised transport services — all pre-booked, all at a fixed price.",
    ...
    (
        "home.how.step2.body",
        "home",
        "Innerhalb von 30 Minuten erhalten Sie unser verbindliches Festpreis-Angebot.",
        "Within 30 minutes you receive our binding fixed-price quote.",
        "Step 2 body",
        False,
    ),
    (
    ...
    (
        ...
        "Fixed price instead of taximeter — the price is set before the ride.",
        "Why bullet 1",
        False,
    ),
    (
    ...
    (
        ...
        "services",
        "Vier spezialisierte Transportdienstleistungen für Privat- und Geschäftskunden im Raum Stuttgart.",
        "Four specialised transport services for private and business customers in the Stuttgart area.",
    ...
    (
        ...
        "services",
        "Festpreis innerhalb von 30 Min.",
        "Fixed price within 30 min",
        "HIW step 2 heading",
        False,
    ),
    (
        ...
        "services",
        "Während der Telefonzeiten bestätigen wir Festpreis, Fahrer und Fahrzeug. Ab diesem Moment ist der Preis fixiert.",
        "During phone hours we confirm the fixed price, the driver and the vehicle. The price is locked from that moment on.",
        "HIW step 2 body",
        False,
    ),
    (
    ...
    (
        ...
        "services",
        "Kein Heranrufen, keine App-Dispatch, kein Surge. Der bestätigte Festpreis ist der Preis, den Sie zahlen — auch im Stau, auch an Feiertagen.",
        "No hailing, no app dispatch, no surge. The fixed price you confirmed is the fixed price you pay — same in traffic, same on holidays.",
        "HIW step 3 body",
        False,
    ),
    ...
    (
        ...
        "services",
        "Festpreis-Strecken ansehen?",
        "Looking for fixed-price routes?",
    ...
    (
        "pricing.page.intro",
        "pricing",
        "Alle Preise inkl. MwSt. Der Preis steht vor Fahrtbeginn fest und ändert sich nicht.",
        "All prices include VAT. The price is fixed before departure and does not change.",
    ...
    (
        ...
        "All prices include VAT. Fixed-price guarantee from booking confirmation.",
    ...
    (
        ...
        "All prices include VAT. Fixed-price guarantee from booking confirmation. Other routes on request.",
    ...
    (
        ...
        "Choose a service to view all fixed-price routes. Other destinations get a quote within 30 minutes.",
    ...
    (
        ...
        "pricing",
        "Was Ihr Festpreis abdeckt",
        "What your fixed price covers",
    ...
    (
        ...
        "pricing",
        "Festpreis 70 € — bei Buchung bestätigt",
        "Fixed €70 — confirmed at booking",
    ...
    (
        ...
        "about",
        "Festpreise vor der Fahrt. Keine versteckten Aufschläge, keine Taxameter-Überraschungen.",
        "Fixed prices up front. No hidden surcharges, no meter surprises.",
        "Value body 3",
        False,
    ),
    (
    ...
    (
        "about.area.body",
        "about",
        "Wir fahren in der Region Stuttgart, Esslingen, Deizisau und im mittleren Neckartal — sowie zu allen umliegenden Flughäfen.",
        "We operate in the Stuttgart, Esslingen, Deizisau region and the central Neckar valley — plus rides to all surrounding airports.",
    ...
    (
        ...
        "about",
        "Wir bedienen die Region Stuttgart, Esslingen, Deizisau und das gesamte mittlere Neckartal — sowie Fahrten zu allen umliegenden Flughäfen.",
        "We serve the Stuttgart, Esslingen, Deizisau region and the entire central Neckar valley — plus rides to all surrounding airports.",
    ...
    (
        ...
        "booking",
        "In wenigen Schritten zur unverbindlichen Buchungsanfrage. Wir melden uns mit Ihrem Festpreis.",
        "A few steps to your non-binding booking request. We'll get back with your fixed price.",
        "Booking page subhead",
        True,
    ),
    (
    ...
    (
        ...
        "booking",
        "Damit wir uns mit Ihrem Festpreis melden können.",
        "So we can get back to you with your fixed price.",
        "Step 4 subhead",
        True,
    ),
    (
    ...
    (
        ...
        "booking",
        "Buchungsanfrage absenden — wir melden uns mit Ihrem Festpreis innerhalb von 2 Stunden.",
        "Submit your booking request — we'll come back with a fixed price within 2 hours.",
        "Step 5 subhead",
        True,
    ),
    (
    ...
    (
        ...
        "booking",
        "Wir melden uns innerhalb von 30 Minuten mit einem verbindlichen Festpreis-Angebot.",
        "We'll get back to you within 30 minutes with a binding fixed-price quote.",
        "Confirmation body",
        True,
    ),
    (
    ...
    (
        ...
        "booking",
        "Sie erhalten innerhalb von 2 Stunden eine telefonische Rückmeldung mit Ihrem Festpreis.",
        "Within 2 hours, we'll call you back with your fixed price.",
        "Confirmation step 1",
        True,
    ),
    (
    ...
    (
        "footer.col.brand",
        "footer",
        "StepNow Rides & Movers — Ihr regionaler Partner für vorbestellte Fahrten in der Region Stuttgart.",
        "StepNow Rides & Movers — your regional partner for pre-booked transfers in the Stuttgart region.",
