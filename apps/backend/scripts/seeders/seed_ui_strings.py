...
UI_STRINGS: list[tuple[str, str, str, str, str | None, bool]] = [
    ...
    (
        ...
        "Pre-booked transfers in the Plochingen/Esslingen. Licensed under § 49 PBefG.",
    ...
    (
        ...
        "home",
        "Vier spezialisierte Transportdienstleistungen — alle vorbestellt, alle …zum Pauschalpreis.",
    ...
    (
        "pricing.tabs.lead",
        "pricing",
        "Wählen Sie einen Service, um alle Pauschalpreis anzusehen. Andere Strecken erhalten ein Angebot innerhalb von 30 Minuten.",
    ...
    (
        ...
        "I'm Naeem Ahmad — owner of StepNow Rides & Movers and a driver in the Plochingen/Esslingen for more than ten years.",
        "Story paragraph 1",
        False,
    ),
    (
    ...
    (
        ...
        "about",
        "Pauschalpreise vor der Fahrt. Keine versteckten.",
    ...
    (
        ...
        "StepNow Rides & Movers — your regional partner for pre-booked transfers in the Plochingen/Esslingen.",
