    ...
    "flughafentransfer": [
        {
            ...
            "items": [
                ...
                {"sort_order": 50, "from_de": "Göppingen", "from_en": "Göppingen", "to_de": "Flughafen Stuttgart", "to_en": "Stuttgart Airport", "price": "75.00", "note_de": None, "note_en": None},
                {"sort_order": 60, "from_de": "Tübingen", "from_en": "Tübingen", "to_de": "Flughafen Stuttgart", "to_en": "Stuttgart Airport", "price": "85.00", "note_de": None, "note_en": None},
            ],
        },
        {
            "sort_order": 20,
            ...
            "items": [
                {"sort_order": 10, "from_de": "Stuttgart", "from_en": "Stuttgart", "to_de": "Flughafen Frankfurt", "to_en": "Frankfurt Airport", "price": "320.00", "note_de": "ca. 2 Stunden Fahrt", "note_en": "approx. 2 hours travel"},
                {"sort_order": 20, "from_de": "Esslingen", "from_en": "Esslingen", "to_de": "Flughafen Frankfurt", "to_en": "Frankfurt Airport", "price": "330.00", "note_de": None, "note_en": None},
                {"sort_order": 30, "from_de": "Deizisau", "from_en": "Deizisau", "to_de": "Flughafen Frankfurt", "to_en": "Frankfurt Airport", "price": "340.00", "note_de": None, "note_en": None},
            ],
        },
        {
            "sort_order": 30,
            ...
            "items": [
                {"sort_order": 10, "from_de": "Stuttgart", "from_en": "Stuttgart", "to_de": "Flughafen München", "to_en": "Munich Airport", "price": "380.00", "note_de": "ca. 2,5 Stunden Fahrt", "note_en": "approx. 2.5 hours travel"},
                {"sort_order": 20, "from_de": "Esslingen", "from_en": "Esslingen", "to_de": "Flughafen München", "to_en": "Munich Airport", "price": "390.00", "note_de": None, "note_en": None},
            ],
        },
    ],
    "krankenhausfahrten": [
        {
            ...
            "items": [
                {"sort_order": 10, "from_de": "Esslingen Innenstadt", "from_en": "Esslingen city centre", "to_de": "Klinikum Esslingen", "to_en": "Esslingen Hospital", "price": "18.00", "note_de": "inkl. Wartezeit am Eingang", "note_en": "Includes wait at entrance"},
                {"sort_order": 20, "from_de": "Deizisau", "from_en": "Deizisau", "to_de": "Klinikum Esslingen", "to_en": "Esslingen Hospital", "price": "22.00", "note_de": None, "note_en": None},
                {"sort_order": 30, "from_de": "Plochingen", "from_en": "Plochingen", "to_de": "Klinikum Esslingen", "to_en": "Esslingen Hospital", "price": "28.00", "note_de": None, "note_en": None},
                {"sort_order": 40, "from_de": "Wendlingen", "from_en": "Wendlingen", "to_de": "Klinikum Esslingen", "to_en": "Esslingen Hospital", "price": "32.00", "note_de": None, "note_en": None},
            ],
        },
        {
            "sort_order": 20,
            ...
            "items": [
                {"sort_order": 10, "from_de": "Deizisau", "from_en": "Deizisau", "to_de": "Klinikum Stuttgart (Mitte)", "to_en": "Klinikum Stuttgart (Mitte)", "price": "42.00", "note_de": None, "note_en": None},
                {"sort_order": 20, "from_de": "Deizisau", "from_en": "Deizisau", "to_de": "Marienhospital Stuttgart", "to_en": "Marienhospital Stuttgart", "price": "45.00", "note_de": None, "note_en": None},
                {"sort_order": 30, "from_de": "Deizisau", "from_en": "Deizisau", "to_de": "Robert-Bosch-Krankenhaus", "to_en": "Robert-Bosch-Krankenhaus", "price": "48.00", "note_de": None, "note_en": None},
                {"sort_order": 40, "from_de": "Esslingen", "from_en": "Esslingen", "to_de": "Klinikum Stuttgart (Mitte)", "to_en": "Klinikum Stuttgart (Mitte)", "price": "38.00", "note_de": None, "note_en": None},
                {"sort_order": 50, "from_de": "Esslingen", "from_en": "Esslingen", "to_de": "BG-Unfallklinik Tübingen", "to_en": "BG Trauma Clinic Tübingen", "price": "85.00", "note_de": None, "note_en": None},
            ],
        },
    ],
    "schuelerbefoerderung": [
        {
            ...
            "items": [
                {"sort_order": 10, "from_de": "Deizisau", "from_en": "Deizisau", "to_de": "Gymnasium Esslingen", "to_en": "Esslingen Gymnasium", "price": "180.00", "note_de": "monatlich, inkl. Hin- und Rückfahrt", "note_en": "Monthly, includes outbound and return"},
                {"sort_order": 20, "from_de": "Plochingen", "from_en": "Plochingen", "to_de": "Gymnasium Esslingen", "to_en": "Esslingen Gymnasium", "price": "240.00", "note_de": "monatlich, inkl. Hin- und Rückfahrt", "note_en": "Monthly, includes outbound and return"},
                {"sort_order": 30, "from_de": "Esslingen", "from_en": "Esslingen", "to_de": "Stuttgarter Gymnasium", "to_en": "Stuttgart Gymnasium", "price": "320.00", "note_de": "monatlich, inkl. Hin- und Rückfahrt", "note_en": "Monthly, includes outbound and return"},
            ],
        },
        {
            "sort_order": 20,
            ...
            "items": [
                {"sort_order": 10, "from_de": "Deizisau", "from_en": "Deizisau", "to_de": "Schule in Esslingen", "to_en": "Esslingen school", "price": "18.00", "note_de": "Einzelfahrt", "note_en": "Single ride"},
                {"sort_order": 20, "from_de": "Plochingen", "from_en": "Plochingen", "to_de": "Schule in Esslingen", "to_en": "Esslingen school", "price": "24.00", "note_de": "Einzelfahrt", "note_en": "Single ride"},
            ],
        },
    ],
    "shuttle-service": [
        {
            ...
            "items": [
                {"sort_order": 10, "from_de": "Sedan (bis 3 Personen)", "from_en": "Sedan (up to 3 passengers)", "to_de": "Stundenpreis", "to_en": "Hourly rate", "price": "65.00", "note_de": "pro Stunde, mind. 3 Std.", "note_en": "Per hour, min. 3 hrs"},
                {"sort_order": 20, "from_de": "Van (bis 8 Personen)", "from_en": "Van (up to 8 passengers)", "to_de": "Stundenpreis", "to_en": "Hourly rate", "price": "85.00", "note_de": "pro Stunde, mind. 3 Std.", "note_en": "Per hour, min. 3 hrs"},
            ],
        },
        {
            "sort_order": 20,
...
def run() -> None:
    ...
    try:
        ...
        for service_slug, categories in PRICING_DATA.items():
            svc = db.query(Service).filter(Service.slug_de == service_slug, Service.is_deleted == False).first()
            if not svc:
                print(f"  [warn] service '{service_slug}' not found — run seed_services first")
                continue
            for cat_data in categories:
                existing_cat = db.query(PricingCategory).filter(
        ...
        print(f"  [done] {total_cats_created} categories created ({total_cats_skipped} skipped), {total_items_created} items created")
    finally:
        db.close()
